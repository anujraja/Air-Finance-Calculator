    ...
    <div className="flex flex-col gap-5">
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
        <div className="rounded-lg border border-accent/20 bg-accent-soft/40 p-3">
          ...
          <p data-testid="time-to-goal" className="mt-1 font-mono text-lg font-semibold tracking-tight tabular-nums text-accent-ink sm:text-xl">
            {headline}
          </p>
        </div>
        <div className="rounded-lg border border-line bg-surface-2/50 p-3">
          <p className="text-xs font-medium uppercase tracking-wide text-ink-faint">Down-payment goal</p>
          <p className="mt-1 font-mono text-lg font-semibold tracking-tight tabular-nums text-ink sm:text-xl">{formatCADWhole(target)}</p>
        </div>
        <div className="col-span-2 rounded-lg border border-line bg-surface-2/50 p-3 sm:col-span-1">
          ...
          <p className="mt-1 flex flex-wrap items-baseline font-mono text-lg font-semibold tracking-tight tabular-nums text-ink">
